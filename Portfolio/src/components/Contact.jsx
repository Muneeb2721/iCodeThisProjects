function Contact() {
    return (
        <div className="contact-section flex flex-col gap-8">
            ...
            <div className="contact-list">
                <div className="contact-link flex items-center gap-[1rem] py-[1.5rem] px-[2rem] rounded-[50px] backdrop-blur-[10px] transition-transform duration-300 ease-in-out hover:scale-105 w-fit mx-auto mb-8">
                    ...
                    <p className="contact-link-para text-[1.2rem]">muneeb@muneebnadeem.dev</p>
                </div>
                <div className="contact-link flex items-center gap-[1rem] py-[1.5rem] px-[2rem] rounded-[50px] backdrop-blur-[10px] transition-transform duration-300 ease-in-out hover:scale-105 w-fit mx-auto mb-8">
                    <div className="w-[50px] h-[50px] rounded-[50%] bg-[rgba(255,255,255,0.2)] flex items-center justify-center text-[1.6rem]">💼</div>
                    <p className="contact-link-para text-[1.2rem]">linkedin.com/in/muneebnadeem</p>
                </div>
                <div className="contact-link flex items-center gap-[1rem] py-[1.5rem] px-[2rem] rounded-[50px] backdrop-blur-[10px] transition-transform duration-300 ease-in-out hover:scale-105 w-fit mx-auto mb-8">
                    <div className="w-[50px] h-[50px] rounded-[50%] bg-[rgba(255,255,255,0.2)] flex items-center justify-center text-[1.6rem]">🐙</div>
                    <p className="contact-link-para text-[1.2rem]">github.com/MuneebNadeem2721</p>
                </div>
            </div>
        </div>
    );
